        ...
        <div className="mx-auto w-full max-w-sm rounded-lg border border-slate-700 bg-slate-900 p-8 text-white shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                    <label className="text-xs font-semibold uppercase text-slate-400">Access Key</label>
                    <input name="password" type="password" required className="w-full border-b border-slate-600 bg-transparent py-2 text-sm outline-none focus:border-white" placeholder="••••••••" />
                </div>
